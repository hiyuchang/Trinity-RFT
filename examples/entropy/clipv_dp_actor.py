...
class DataParallelPPOActor(OriginalDPActor):
    ...
    def compute_log_prob(
        ...
        Returns:
            - when calculate_nec is False: (log_probs, entropys)
            - when calculate_nec is True: (log_probs, entropys, necs)
        """
        # set to eval
    ...
    def _forward_micro_batch(  # type: ignore # noqa: C901
        self, micro_batch, temperature, calculate_entropy: bool = False, calculate_nec: bool = False
